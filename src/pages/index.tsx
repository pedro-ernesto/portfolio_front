    ...
    <Flex direction={'column'} h={'100vh'}>
      ...
      >
        <Box maxWidth='600px'>
          ...
          <Text mt={4} fontSize={'24'} fontWeight='light' color="white"> I’m a Full Stack Dev specialized in building web
            and mobile apps with react, react native and node.js.</Text>
          <Button 
            mt={10}
            fontSize={'20px'}
            fontWeight={"semibold"} 
            borderRadius={'100px'} width="260px" h="64px" background={"yellow"} color="black">Explore my work</Button>
        </Box>
